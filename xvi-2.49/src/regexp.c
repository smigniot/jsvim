...
#define FAIL(m) 	{ vim_regerror(m); return(NULL); }
...
int at_bol;
{
	...
	vim_regerror("NULL parameter");
	return(0);
    }

    /* Check validity of program. */
    if (UCHARAT(prog->program) != MAGIC) {
	vim_regerror("Corrupted program");
	return(0);
    }
...
char *prog;
{
	...
	case END:
	    ...
	    break;
	default:
	    vim_regerror("Memory corruption");
	    return(0);
	    break;
	}
     ...
     */
    vim_regerror("Corrupted pointers");
    return(0);
}
